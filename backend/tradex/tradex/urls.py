...
from apps.accounts.views import health_check, home as home_view
...
# Serve the new public Django home page at root, then built frontend (Vite) index.html for SPA routes that are not API or admin
urlpatterns += [
